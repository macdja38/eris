    ...
    */
    constructor(token, options) {
        ...
        if (this.options.workerPort) {
            ...
            this.workerWSS.sendWS = function(json) {
                this.workerWSS.send(JSON.stringify(json));
            };

            this.workerWSS.on('message', (data) => {
