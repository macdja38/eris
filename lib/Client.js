...
class Client extends EventEmitter {
    ...
    */
    ...
    _voiceServerUpdate(packet) {
        console.log("VoiceServerUpdatePacket", packet);
        if(packet.token && packet.endpoint && packet && packet.user_id && packet.guild_id) {
            console.log("Stage 1");
            console.log(this.joinPendingVoiceConnections);
            if (this.joinPendingVoiceConnections.hasOwnProperty(packet.guild_id)) {
                console.log("Stage 2");
                var pendingVoiceConn = this.joinPendingVoiceConnections[packet.guild_id];
                pendingVoiceConn.resolve({
                     endpoint: packet.endpoint,
                    guild_id: packet.guild_id,
                    session_id: pendingVoiceConn.session_id,
                    token: packet.token,
        ...
        console.log("voiceServerUpdate", packet);
    }
