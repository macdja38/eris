        ...
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            ...
            case "VOICE_STATE_UPDATE": { // (╯°□°）╯︵ ┻━┻
                ...
                if(member.user.id === this.client.user.id) {
                    if (this.client.joinPendingVoiceConnections.hasOwnProperty(packet.d.guild_id)) {
                        this.client.joinPendingVoiceConnections[packet.d.guild_id].session_id = packet.d.session_id;
                        this.client.voiceSessions[packet.d.guild_id] = packet.d.session_id;
                    }
                    this.client._voiceChannelUpdate(packet.d);
                }
            ...
            case "VOICE_SERVER_UPDATE": {
                ...
                packet.d.shard = this;
                console.log("Recieved Voice Server Update");
                this.client._voiceServerUpdate(packet.d);
                break;
            }
            case "USER_UPDATE": {
                var user = this.client.users.get(packet.d.user.id);
